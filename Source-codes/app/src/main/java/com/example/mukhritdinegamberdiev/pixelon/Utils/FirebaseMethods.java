package com.example.mukhritdinegamberdiev.pixelon.Utils;
...
import com.example.mukhritdinegamberdiev.pixelon.Profile.AccountSettingsActivity;
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            ...
                            ((AccountSettingsActivity)mContext).setViewPager(
                                    ((AccountSettingsActivity)mContext).pagerAdapter
                                            .getFragmentNumbers(mContext.getString(R.string.edit_profile))
                            );
