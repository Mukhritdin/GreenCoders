...
import com.example.mukhritdinegamberdiev.pixelon.Utils.SectionsStatePagerAdapter;
...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    private void getIncomingIntent(){
        ...
        if(intent.hasExtra(getString(R.string.calling_activity))){
            ...
            setViewPager(pagerAdapter.getFragmentNumbers(getString(R.string.edit_profile)));
        }
    }
